...
1. **Flash Microcontroller**: Ensure your ESP32 or Arduino is programmed to output values over serial in the following format:
   ...
   ```
   *(For example, the serial output should stream lines like `41240,2048` at 1000Hz. See the default template inside `scripts/emg_reader_esp32/emg_reader_esp32.ino`).*
